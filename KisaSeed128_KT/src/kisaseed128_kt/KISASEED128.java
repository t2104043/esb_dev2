...
@XPathFunctionGroup(category = "KISA SEED 128", prefix = "kt", namespace = "http://kisaseed.com", helpText = "Custom defined function")
public class KISASEED128 {
	...
	public String getdayofWeek() {
		...
		String result = now.getDayOfWeek().getDisplayName(TextStyle.SHORT, Locale.KOREAN).toString();
		return result;
	}
	...
	@XPathFunction(helpText = "Description", parameters = {
			@XPathFunctionParameter(name = "pbszUserKey", optional = false, optionalValue = ""),
			@XPathFunctionParameter(name = "pbData", optional = false, optionalValue = ""),
			@XPathFunctionParameter(name = "offset", optional = false, optionalValue = ""),
			@XPathFunctionParameter(name = "length", optional = false, optionalValue = "") })
	public String ECB_Enc(String pbszUserKey, String pbData, int offset, int length) {
		
		byte encValue[]   = new byte[50];
		encValue = SEED_ECB_Encrypt(pbszUserKey.getBytes(), pbData.getBytes(), offset, length);
	...
	@XPathFunction(helpText = "Description", parameters = {
			...
			@XPathFunctionParameter(name = "offset", optional = false, optionalValue = ""),
			@XPathFunctionParameter(name = "length", optional = false, optionalValue = "") })
	public String ECB_Dec(String pbszUserKey, String pbData, int offset, int length) {
		
		byte[] ByteArray = hexStringToByteArray(pbData);

		byte decValue[]   = new byte[16];
		decValue = SEED_ECB_Decrypt(pbszUserKey.getBytes(), ByteArray, offset, length);
